        ...
        <div className="mx-auto max-w-[1220px] px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-[1fr_2fr] items-start">
            ...
            <div className="border-4 border-white p-6">
              ...
              <p className="text-white font-jakarta text-sm md:text-base leading-relaxed">
                É um processo intensivo de 30 dias para destravar o crescimento da sua empresa e entregar:
              </p>
            </div>

            {/* Benefícios - Texto maior e com blocos de fundo */}
            <div className="grid gap-6 md:grid-cols-2">
              <div className="bg-white/10 p-5 rounded-lg">
                <p className="text-white font-semibold font-jakarta text-[25px] leading-[32px] tracking-[-0.03em]">
        ...
        <div className="mx-auto max-w-[1220px] px-4 sm:px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-[1fr_2fr] items-center bg-white p-8 shadow-lg">
            ...
            <div className="border-4 border-[#6767F1] p-6">
              ...
              <button className="w-full bg-[#F5C402] text-black font-semibold py-3 px-6 uppercase hover:brightness-95 transition">
                Receber Diagnóstico
              </button>
            </div>
            ...
            <div className="text-[#5C5C5C] font-jakarta">
              <p className="text-lg leading-relaxed">
                Se você não enxergar valor prático na entrega final, devolvemos 100% do investimento.
              </p>
            </div>
          </div>
        </div>
